...
public interface IDbYcsbClient
{
    ...
    /// <returns>
    /// A <see cref="Response{T}"/> indicating success or failure of the operation.
    /// </returns>
    ...
    /// <returns>
    /// A <see cref="Response{T}"/> describing the result of the update operation.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    /// A <see cref="Response{T}"/> indicating the result of the delete-all operation.
    /// </returns>
